...
gcc -Wall -Werror -Wextra -pedantic -std=gnu89 prompt_user.c custom_strcmp.c handl_getline.c shell.c handl_strtok.c custom_getline.c custom_read.c file_check.c path_check.c fork_exec.c free_argv.c free_argv2.c handl_premade_path.c handl_unpath.c custom_printf.c custom_strlen.c custom_strcat.c custom_strcpy.c custom_realloc.c -o hsh
